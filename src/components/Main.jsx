    ...
    return (
        <div id='main' className='pt-[75px] h-[100%] text-white bg-[#405855]'>
            <div className='sm:px-6 pb-24 md:pb-0 md:h-[90vh]'>
                <div className={sidebarVal ? 'duration-500 blur-sm pl-14 sm:pl-18 md:pl-20 pr-20 pt-14' : 'duration-500 pl-10 pr-4 sm:pr-0 md:pl-20 lg:pl-28 pr-15 md:pr-20 pt-12 md:pt-18 lg:pt-20'}>
                    <div className='text-[#fdfcfc] pr-4 sm:pr-0'>
                        ...
                        <h1 className='text-3xl sm:text-4xl md:text-5xl font-semibold pt-2'>I design and build modern and classic looking websites.</h1>
